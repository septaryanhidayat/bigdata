                    ...
                    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center text-white space-y-3 sm:space-y-4">
                        ...
                        <div class="pt-3 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
                            <a href="{{ route('school.ppdb') }}?unit={{ $codeLower }}" 
                               class="px-6 sm:px-8 py-3 rounded-full font-black text-xs uppercase tracking-wider bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 shadow-xl shadow-amber-500/30 hover:shadow-amber-500/50 hover:scale-105 active:scale-95 transition duration-200 flex items-center space-x-2">
                                <i class="fa-solid fa-graduation-cap"></i>
                                <span>Daftar SPMB Sekarang</span>
                            </a>
                            <a href="{{ url('/unit/' . $codeLower . '/profil') }}" 
                               class="px-6 sm:px-7 py-3 rounded-full font-bold text-xs uppercase tracking-wider bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-md transition duration-200 flex items-center space-x-2">
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section class="-mt-8 sm:-mt-12 relative z-30 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div class="bg-white rounded-3xl p-4 sm:p-6 shadow-2xl border border-gray-100">
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-4 text-center">
            
            <a href="{{ route('school.ppdb') }}?unit={{ $codeLower }}" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-amber-100 text-amber-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-graduation-cap"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">SPMB Online</span>
            </a>

            <a href="{{ url('/unit/' . $codeLower . '/profil') }}" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-indigo-100 text-indigo-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-school"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Profil</span>
            </a>

            <a href="#guru" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-cyan-100 text-cyan-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-chalkboard-user"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Dewan Guru</span>
            </a>

            <a href="#fasilitas" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-emerald-100 text-emerald-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-layer-group"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Fasilitas</span>
            </a>

            <a href="#program" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-purple-100 text-purple-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-star"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Unggulan</span>
            </a>

            <a href="#berita" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-trophy"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Prestasi</span>
            </a>

            <a href="#agenda" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-blue-100 text-blue-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-calendar-days"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Agenda</span>
            </a>

            <a href="{{ asset('/uploads/panduan-tahfidz-ishum.pdf') }}" target="_blank" class="group p-3 rounded-2xl hover:bg-indigo-50 transition duration-200 flex flex-col items-center">
                <div class="w-12 h-12 rounded-2xl bg-rose-100 text-rose-600 flex items-center justify-center text-xl mb-2 group-hover:scale-110 transition shadow-inner">
                    <i class="fa-solid fa-download"></i>
                </div>
                <span class="text-xs font-bold text-gray-800 group-hover:text-indigo-600">Download</span>
            </a>
...
<section class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div class="bg-gradient-to-r from-indigo-950 via-indigo-900 to-blue-950 rounded-3xl p-6 sm:p-10 text-white shadow-2xl border border-indigo-500/30 reveal-fade-up relative overflow-hidden">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            {{-- FLYER 3:4 SISI KIRI --}}
            <div class="lg:col-span-4 flex justify-center">
                <div class="w-64 sm:w-72 rounded-2xl overflow-hidden shadow-2xl border-4 border-amber-400/40 ring-4 ring-indigo-500/30 group">
            ...
            <div class="lg:col-span-8 space-y-5 text-center lg:text-left">
                <div class="inline-flex items-center space-x-2 bg-amber-400/20 text-amber-300 border border-amber-400/30 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
                ...
                <div class="pt-3 flex flex-wrap items-center justify-center lg:justify-start gap-3">
                    <a href="{{ route('school.ppdb') }}?unit={{ $codeLower }}" 
                       class="px-7 py-3 rounded-full font-black text-xs uppercase tracking-wider bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 hover:scale-105 active:scale-95 transition duration-200 flex items-center space-x-2">
                        <i class="fa-solid fa-graduation-cap"></i>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=62{{ ltrim($info['whatsapp'] ?? $info['phone'] ?? '85269908696', '0') }}" 
                       ...
                       class="px-6 py-3 rounded-full font-bold text-xs uppercase tracking-wider bg-white/10 hover:bg-white/20 text-white border border-white/20 backdrop-blur-md transition flex items-center space-x-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div class="lg:col-span-8 space-y-4 text-left">
                ...
                <div class="pt-2 flex items-center space-x-3">
                    ...
                    <a href="{{ url('/unit/' . $codeLower . '/profil') }}" 
                       class="inline-flex items-center space-x-2 px-6 py-3 rounded-full text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-800 transition">
...
<section id="program" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        @foreach($programs as $prog)
            <div class="bg-white rounded-3xl p-6 shadow-xl border border-gray-100 hover:border-amber-400 hover:-translate-y-1 transition duration-300 space-y-3 reveal-fade-up">
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section id="guru" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
    <div class="text-center space-y-2">
        <span class="text-xs font-black uppercase tracking-wider text-indigo-600 block">Tenaga Pendidik</span>
        <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">Dewan Guru &amp; Tenaga Kependidikan</h2>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        @foreach($teacherList as $tc)
            <div class="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition duration-300 reveal-fade-up text-center group">
                <div class="h-56 sm:h-64 overflow-hidden bg-indigo-50">
                ...
                <div class="p-4 space-y-1">
                    ...
                    <p class="text-[10px] sm:text-xs text-indigo-600 font-semibold">{{ $tc['role'] }}</p>
                </div>
            </div>
        @endforeach
    </div>
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section id="video" class="py-16 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white">
    <div class="max-w-7xl mx-auto space-y-10">
        <div class="text-center space-y-2">
            <span class="text-xs font-black uppercase tracking-wider text-amber-400 block">Dokumentasi Multimedia</span>
            <h2 class="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Galeri Video Resmi</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-slate-900 rounded-2xl overflow-hidden border border-slate-800 shadow-xl group">
                <div class="relative h-48 bg-slate-800 flex items-center justify-center">
                    <img src="/uploads/campus-smpit-ishum.webp" alt="Video Profil Sekolah" class="w-full h-full object-cover opacity-60">
                    <a href="https://www.youtube.com" target="_blank" class="absolute w-12 h-12 rounded-full bg-red-600 text-white flex items-center justify-center text-lg shadow-lg group-hover:scale-110 transition">
        ...
        <div class="text-center pt-2">
            <a href="https://youtube.com" target="_blank" 
               class="inline-flex items-center space-x-2 px-7 py-3 rounded-full font-bold text-xs bg-red-600 hover:bg-red-700 text-white shadow-lg transition">
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section id="agenda" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        
        {{-- KOLOM PENGUMUMAN --}}
        <div class="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-100 space-y-6 reveal-fade-up">
        ...
        <div class="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-100 space-y-6 reveal-fade-up delay-1">
            <div class="flex items-center justify-between pb-4 border-b border-gray-100">
                <h3 class="text-base font-extrabold text-gray-900 flex items-center gap-2">
            ...
            <div class="space-y-4">
                ...
                @foreach($agendas as $ag)
                    <div class="flex items-start space-x-4 p-3.5 rounded-2xl bg-gray-50/80 border border-gray-100 hover:border-indigo-200 transition">
                        ...
                        <div class="space-y-1">
                            <h4 class="text-xs font-bold text-gray-900">{{ $ag['title'] }}</h4>
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section id="galeri" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
    <div class="text-center space-y-2">
        <span class="text-xs font-black uppercase tracking-wider text-indigo-600 block">Dokumentasi Santri</span>
        <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">Galeri Foto Santri</h2>
        <div class="w-16 h-1 bg-amber-400 rounded-full mx-auto"></div>
    </div>

    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="rounded-2xl overflow-hidden shadow-md h-44 sm:h-52 bg-gray-100 group">
    ...
    <div class="text-center pt-2">
        <a href="#galeri" class="inline-flex items-center space-x-2 px-6 py-2.5 rounded-full text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-700 transition">
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section class="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div class="rounded-3xl bg-gradient-to-r from-indigo-950 via-indigo-900 to-blue-950 p-8 sm:p-12 text-white shadow-2xl border border-indigo-500/30 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
        <div class="space-y-2">
        ...
        <a href="{{ route('school.ppdb') }}?unit={{ $codeLower }}" 
           class="px-8 py-3.5 rounded-full font-black text-xs uppercase tracking-wider bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 shadow-xl shadow-amber-500/30 hover:scale-105 active:scale-95 transition shrink-0">
            Daftar SPMB Online
        </a>
    </div>
</section>
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section class="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div class="bg-[#0f172a] rounded-3xl p-8 sm:p-12 text-white space-y-8 border border-slate-800">
        <div class="text-center space-y-2">
            <span class="text-xs font-black uppercase tracking-wider text-amber-400 block">Kurikulum Holistik</span>
            <h2 class="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">5 Bidang Literasi Kehidupan</h2>
        </div>
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div class="rounded-2xl overflow-hidden border border-slate-800 h-52 group relative">
...
{{-- ========================================================
     ...
     ======================================================== --}}
<section id="testimoni" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
    <div class="text-center space-y-2">
        <span class="text-xs font-black uppercase tracking-wider text-indigo-600 block">Kesan &amp; Pengalaman</span>
        <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">Testimoni Wali &amp; Alumni</h2>
        <div class="w-16 h-1 bg-amber-400 rounded-full mx-auto"></div>
    </div>
...
<section class="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('school.ppdb') }}?unit={{ $codeLower }}" class="bg-white rounded-2xl p-5 shadow-lg border-t-4 border-indigo-600 hover:shadow-xl transition flex items-center space-x-4">
        ...
        <a href="https://api.whatsapp.com/send?phone=62{{ ltrim($info['whatsapp'] ?? $info['phone'] ?? '85269908696', '0') }}" target="_blank" class="bg-white rounded-2xl p-5 shadow-lg border-t-4 border-amber-500 hover:shadow-xl transition flex items-center space-x-4">
        ...
        <a href="{{ route('school.layanan.kunjungan') }}" class="bg-white rounded-2xl p-5 shadow-lg border-t-4 border-blue-600 hover:shadow-xl transition flex items-center space-x-4">
