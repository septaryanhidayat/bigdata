            ...
            <article class="lg:col-span-8 space-y-5 sm:space-y-6">
                ...
                <div class="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-slate-50 dark:bg-[#07170a] border border-slate-200 dark:border-[#1a3d1e] space-y-3 sm:space-y-0 sm:flex sm:items-center sm:justify-between sm:gap-4 shadow-xs">
                    ...
                    <div class="flex flex-wrap items-center justify-center sm:justify-end gap-2 shrink-0">
                        <!-- WhatsApp -->
                        <a href="https://api.whatsapp.com/send?text={{ urlencode($news['title'] . ' ' . request()->fullUrl()) }}" target="_blank" title="Bagikan ke WhatsApp" class="w-10 h-10 rounded-xl bg-[#25D366] hover:bg-[#1fa951] text-white flex items-center justify-center shadow-sm hover:scale-110 transition-all">
                        ...
                        <!-- Telegram -->
                        <a href="https://t.me/share/url?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode($news['title']) }}" target="_blank" title="Bagikan ke Telegram" class="w-10 h-10 rounded-xl bg-[#229ED9] hover:bg-[#1c80b0] text-white flex items-center justify-center shadow-sm hover:scale-110 transition-all">
                        ...
                        <!-- Threads -->
                        <a href="https://www.threads.net/intent/post?text={{ urlencode($news['title'] . ' ' . request()->fullUrl()) }}" target="_blank" title="Bagikan ke Threads" class="w-10 h-10 rounded-xl bg-[#000000] hover:bg-slate-900 text-white flex items-center justify-center shadow-sm hover:scale-110 transition-all border border-slate-800">
                        ...
                        <!-- X / Twitter -->
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($news['title']) }}&url={{ urlencode(request()->fullUrl()) }}" target="_blank" title="Bagikan ke X (Twitter)" class="w-10 h-10 rounded-xl bg-[#000000] hover:bg-slate-900 text-white flex items-center justify-center shadow-sm hover:scale-110 transition-all border border-slate-800">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>

                        <!-- Copy Direct Link -->
                        <button onclick="navigator.clipboard.writeText(window.location.href); alert('Tautan berita berhasil disalin ke clipboard!');" title="Salin Tautan" class="w-10 h-10 rounded-xl bg-slate-700 hover:bg-slate-800 text-white flex items-center justify-center shadow-sm hover:scale-110 transition-all">
