...
<body class="bg-slate-50 text-slate-800 font-body transition-colors duration-300 antialiased selection:bg-emerald-500 selection:text-white">
    ...
    <!-- TOP HEADER & NAVIGATION BAR (UNIFIED PARTIAL) -->
