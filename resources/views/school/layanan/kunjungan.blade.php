...
<body class="bg-[#040905] text-slate-100 antialiased min-h-screen pb-24">
    ...
    <main class="py-10 max-w-5xl mx-auto px-4 space-y-8">
        ...
        <div class="text-center space-y-3">
            ...
            <h1 class="text-3xl sm:text-4xl font-black text-white tracking-tight">Permohonan Izin Kunjungan ke Sekolah</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 p-1.5 rounded-2xl bg-[#08120a] border border-[#1a381d]">
            <a href="{{ route('school.layanan.kunjungan') }}" class="p-3.5 rounded-xl border text-center font-black text-xs flex items-center justify-center gap-2 transition-all shadow-md tab-active">
                <span class="text-base">📌</span>
                <span>1. Izin Kunjungan Sekolah</span>
            </a>
            <a href="{{ route('school.layanan.kerjasama') }}" class="p-3.5 rounded-xl border text-center font-black text-xs flex items-center justify-center gap-2 transition-all hover:border-[#a8f52c]/50 tab-inactive">
                <span class="text-base">🤝</span>
        ...
        <div class="card-dark-surface p-6 sm:p-8 rounded-[2rem] space-y-6 shadow-2xl">
            ...
            <div class="flex items-center gap-3 border-b border-[#1f4224] pb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-semibold">Ketentuan resmi pengajuan permohonan kunjungan ke SIT Robbani</p>
                </div>
            </div>
                ...
                <div class="p-5 rounded-2xl bg-[#071208] border border-[#1a381d] space-y-3">
                    ...
                    <ul class="space-y-2 text-slate-300 font-medium pl-1">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <span>Bukti permohonan kunjungan sudah ditandatangani oleh pejabat berwenang &amp; stempel stempel basah dibawa ketika hari kunjungan.</span>
                        </li>
                        <li class="flex items-start gap-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-5 rounded-2xl bg-[#071208] border border-[#1a381d] space-y-3">
                        ...
                        <div class="border-t border-[#19331d] pt-2.5">
                            ...
                            <p class="text-xs font-bold text-white mt-0.5">Permohonan Izin Kunjungan ke Sekolah</p>
                        </div>
                    </div>
        ...
        <div class="p-5 rounded-2xl bg-[#a8f52c] text-[#040905] font-black text-sm space-y-1 shadow-2xl flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs font-bold text-emerald-950">Tim Humas SIT Robbani akan memproses permohonan Anda paling lambat 10 hari kerja.</p>
            </div>
        </div>
        @endif

        <!-- Form Section -->
        <form action="{{ route('school.layanan.kunjungan.store') }}" method="POST" class="card-dark-surface p-6 sm:p-8 rounded-[2rem] space-y-5 shadow-2xl">
            @csrf
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="instansi" required placeholder="Contoh: SDIT Nurul Islam / Universitas / Instansi Dinas" class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    <label class="block text-xs font-black text-[#a8f52c] uppercase">Nama Penanggung Jawab *</label>
                    <input type="text" name="nama_pemohon" required placeholder="Nama lengkap & gelar penanggung jawab" class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
                </div>
                <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    ...
                    <input type="email" name="email" required placeholder="email@instansi.com" class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
                </div>
                <div class="space-y-1.5">
                    <label class="block text-xs font-black text-[#a8f52c] uppercase">Rencana Tanggal Kunjungan (Senin / Kamis) *</label>
                    <input type="date" name="tgl_kunjungan" required class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
                </div>
            </div>

            <div class="space-y-1.5">
                <label class="block text-xs font-black text-[#a8f52c] uppercase">Estimasi Jumlah Peserta (Maksimal 100 Orang) *</label>
                <input type="number" name="jumlah_peserta" max="100" min="1" required placeholder="Contoh: 25" class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
            </div>

            <div class="space-y-1.5">
                <label class="block text-xs font-black text-[#a8f52c] uppercase">Maksud & Tujuan Kunjungan *</label>
                <textarea name="tujuan" rows="4" required placeholder="Jelaskan agenda, topik studi banding, atau maksud kunjungan..." class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]"></textarea>
            </div>
