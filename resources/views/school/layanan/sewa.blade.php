...
<body class="bg-[#040905] text-slate-100 antialiased min-h-screen pb-24">
    ...
    <main class="py-10 max-w-5xl mx-auto px-4 space-y-8">
        ...
        <div class="text-center space-y-3">
            ...
            <h1 class="text-3xl sm:text-4xl font-black text-white tracking-tight">Permohonan Sewa Menyewa Barang Sekolah</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 p-1.5 rounded-2xl bg-[#08120a] border border-[#1a381d]">
            ...
            <a href="{{ route('school.layanan.sewa') }}" class="p-3.5 rounded-xl border text-center font-black text-xs flex items-center justify-center gap-2 transition-all shadow-md tab-active">
                <span class="text-base">🏢</span>
        ...
        <div class="card-dark-surface p-6 sm:p-8 rounded-[2rem] space-y-6 shadow-2xl">
            ...
            <div class="flex items-center gap-3 border-b border-[#1f4224] pb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-semibold">Ketentuan resmi pengajuan permohonan sewa menyewa barang/fasilitas ke SIT Robbani</p>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-5 rounded-2xl bg-[#071208] border border-[#1a381d] space-y-3">
                        ...
                        <div class="border-t border-[#19331d] pt-2.5">
                            ...
                            <p class="text-xs font-bold text-white mt-0.5">Permohonan Sewa Menyewa Barang Sekolah</p>
                        </div>
                    </div>
        ...
        <div class="p-5 rounded-2xl bg-[#a8f52c] text-[#040905] font-black text-sm space-y-1 shadow-2xl flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs font-bold text-emerald-950">Tim Sarpras & Humas SIT Robbani akan memproses ketersediaan barang/fasilitas paling lambat 10 hari kerja.</p>
            </div>
        </div>
        @endif

        <!-- Form Section -->
        <form action="{{ route('school.layanan.sewa.store') }}" method="POST" class="card-dark-surface p-6 sm:p-8 rounded-[2rem] space-y-5 shadow-2xl">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="nama_penyewa" required placeholder="Nama lengkap / perwakilan lembaga" class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
                </div>
                <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    <label class="block text-xs font-black text-[#a8f52c] uppercase">Fasilitas / Barang yang Ingin Disewa *</label>
                    <select name="fasilitas_disewa" required class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
                ...
                <div class="space-y-1.5">
                    <label class="block text-xs font-black text-[#a8f52c] uppercase">Tanggal Penggunaan (Senin / Kamis) *</label>
                    <input type="date" name="tgl_sewa" required class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]">
                </div>
            </div>

            <div class="space-y-1.5">
                <label class="block text-xs font-black text-[#a8f52c] uppercase">Keperluan & Deskripsi Barang/Fasilitas *</label>
                <textarea name="keperluan" rows="4" required placeholder="Jelaskan nama acara, spesifikasi barang/fasilitas yang dibutuhkan, jumlah peserta, dan durasi penggunaan..." class="w-full px-4 py-3 rounded-xl bg-[#071208] border border-[#234928] text-xs font-semibold text-white focus:outline-none focus:border-[#a8f52c]"></textarea>
            </div>
