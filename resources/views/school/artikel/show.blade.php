...
<body class="bg-[#0b1206] text-lime-50 antialiased min-h-screen pb-24 lg:pb-0">
    ...
    <main class="py-12 max-w-4xl mx-auto px-4 space-y-8">
        ...
        <div class="rounded-3xl overflow-hidden card-dark-surface">
            <img src="{{ $article['image'] }}" alt="{{ $article['title'] }}" class="w-full max-h-[450px] object-cover" onerror="this.onerror=null; this.src='/images/logo-robbani-official.png'; this.className='w-full p-8 object-contain bg-white';">
        </div>
