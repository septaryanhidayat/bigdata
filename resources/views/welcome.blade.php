...
<head>
    ...
    <meta property="og:image" content="{{ asset('images/og_share_image.png') }}">
    <meta property="og:image:secure_url" content="{{ asset('images/og_share_image.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('images/og_share_image.png') }}">
