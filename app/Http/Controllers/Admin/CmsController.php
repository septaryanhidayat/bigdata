...
class CmsController extends Controller
{
    ...
    public function settingsPortal()
    {
        $settings = [
            ...
            'contact_address' => SiteSetting::get('contact_address', 'Jl. Sarjana Padang Guci, Kel. Timbangan, Indralaya Utara, Kabupaten Ogan Ilir, Sumatera Selatan'),
            'hero_bg_image' => SiteSetting::get('hero_bg_image', '/uploads/wp_assets/2_7c039504.png'),
