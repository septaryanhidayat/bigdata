...
--
-- Host: localhost:3306
-- Generation Time: Aug 11, 2026 at 08:38 AM
...
(13, '13. SPMB Online', 'SPMB Online', 'operasional', 'Penerimaan Siswa', '📝', 'bg-emerald-100 text-emerald-800', 'Penerimaan Siswa Baru wizard 5-langkah, upload dokumen, konfirmasi bayar, dan transfer master data.', 'Portal SPMB/PPDB publik end-to-end. Calon siswa mendaftar melalui wizard 5 langkah, mengunggah berkas syarat (Akta, KK, Ijazah), konfirmasi bukti bayar, dan jika diterima data otomatis masuk ke Master Siswa.', '[\"Website publik SPMB\\/PPDB dengan desain responsive\",\"Landing page SPMB publik dan Admin CMS untuk halaman, banner, FAQ, biaya, dan jadwal\",\"Registrasi akun calon siswa dengan verifikasi email\",\"Wizard 5 langkah: pribadi, orang tua, sekolah asal, nilai, dan dokumen\",\"Upload dokumen: Akta, KK, Ijazah, dan Foto dengan validasi admin\",\"Konfirmasi pembayaran: upload bukti transfer dan verifikasi TU\",\"Pengaturan gelombang pendaftaran dengan kuota dan tanggal berbeda\",\"Transfer pendaftar diterima langsung ke data siswa master\",\"Download isian Form SPMB oleh wali siswa dalam bentuk PDF\"]', 1, 13, '2026-08-10 12:49:01', '2026-08-10 12:43:58'),
...
(15, '15. Mutaba\'ah BPI & Character', 'BPI Mutaba\'ah', 'bpi', 'Bina Pribadi Islami', '🕌', 'bg-emerald-100 text-emerald-800', 'Laporan amal ibadah harian, validasi digital PIN ortu, Al-Matsurat dzikir, dan API Waktu Sholat Kemenag.', 'Modul Bina Pribadi Islami (BPI) khas SIT Robbani. Checklist ibadah harian anak di rumah yang diawasi orang tua via PIN digital, radar chart pencapaian karakter, modul Al-Matsurat dzikir, dan pengingat waktu sholat.', '[\"Laporan Amal Ibadah Harian: Checklist digital pelaksanaan sholat wajib, rawatib, dhuha, tahajud, tilawah, hafalan Alquran, puasa sunnah, dan infaq harian\",\"Validasi dan Approval Orang Tua via tanda tangan digital atau PIN di Portal Ortu\",\"Dashboard BPI Graphical: Visualisasi radar chart pencapaian amal per siswa dan kelas\",\"Fitur Dzikir dan Doa Digital: Modul Al-Matsurat pagi dan petang interaktif dengan terjemahan dan tasbih virtual\",\"Pengingat Sholat dan Imsakiyah: Integrasi API Kemenag berbasis geolokasi sekolah\",\"Amal Jariyah dan Infaq Harian: Tracking donasi siswa terintegrasi ke Keuangan\"]', 1, 15, '2026-08-10 12:49:01', '2026-08-10 12:41:46'),
...
('50MX3PHq7yrieMyyHPf52Ywako0emKJpLIQmP1Rw', 1, '114.10.98.196', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Mobile Safari/537.36', '', 1786426451),
('FLVCnHI0SiZyReKPciOPRdixW9zh2tjaM0d3N5LO', NULL, '125.167.50.212', 'WhatsApp/2.23.20.0', 'eyJfdG9rZW4iOiJjbGdTVkFacDJEQXpINGdseTlTaTY1ZUhqaXlXcHdkZlZyT3prRFFrIiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHBzOlwvXC9iaWdkYXRhLnNpdHJvYmJhbmkuc2NoLmlkIiwicm91dGUiOiJob21lIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=', 1786424388),
('NmmLw94gK5EdAPmDqHESeL2pAGKADMRBa4776lvV', 1, '125.167.50.212', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.5 Mobile/15E148 Safari/604.1', '', 1786424164),
('NompPvdWLJikKMIUPWFKRqvUEe0nNQhpp9oRlX3a', NULL, '125.167.50.212', 'WhatsApp/2.23.20.0', 'eyJfdG9rZW4iOiJJQW1mNmE4Z0hnblcyWldacEJUU0JRaFZKbTY5QjU4MjVGRU1uV1JsIiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHBzOlwvXC9iaWdkYXRhLnNpdHJvYmJhbmkuc2NoLmlkIiwicm91dGUiOiJob21lIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=', 1786424388),
('wnhJRS64W9xUCu1MqBXJIcXbeJBMtz9S6UHvsvYt', NULL, '114.10.99.27', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Mobile Safari/537.36', 'eyJfdG9rZW4iOiJuaG1BQk1iYkp5MlJWRkRzNFVFV1FBMklwU2tEWW5uWWo3TWN5NmVvIiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHBzOlwvXC9iaWdkYXRhLnNpdHJvYmJhbmkuc2NoLmlkIiwicm91dGUiOiJob21lIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=', 1786429339);
...
('pkg3_price', 'Rp 6.000.000', '2026-08-10 13:02:12', '2026-08-11 02:19:48'),
...
('show_sales_section', '0', '2026-08-10 13:02:12', '2026-08-11 03:34:08'),
...
(1, 'Administrator SmartEdu', 'admin@smartedu.test', NULL, '$2y$12$8lKBaBnD8A5iRXSK3SATCuiERMXTpTRhpU1jQZ7uhA/vkr0YQiZYi', 'iVdWOtapCjwxtdMRXtEpwOBR8RRKI2OK0YA0sgX3NfXonLnEltZ6CF8SMNe5', '2026-08-10 12:49:01', '2026-08-10 12:49:01');
...
--
-- Indexes for table `feature_modules`
--
...
--
-- AUTO_INCREMENT for table `feature_modules`
--
ALTER TABLE `feature_modules`
